...
class Cell():
    def __init__(self, win=None):
        ...
        self._x1 = None #p1.horizontal
        self._x2 = None #p2.horizontal
        self._y1 = None #p1.vertical
        self._y2 = None #p2.vertical
        self._win = win
        self.visited = False
    ...
    def draw(self, x1, y1, x2, y2):
        if self._win is None:
            return
        self._x1 = x1 #p1.horizontal
        self._x2 = x2 #p2.horizontal
        self._y1 = y1 #p1.vertical
        self._y2 = y2
